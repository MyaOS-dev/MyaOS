...
$(BUILD)/kernel.o: kernel/kernel.c kernel/boot.h | $(BUILD)
	$(CC) $(CFLAGS_KERNEL) -c kernel/kernel.c -o $(BUILD)/kernel.o
$(BUILD)/$(KERNEL): $(BUILD)/entry.o $(BUILD)/kernel.o linker.ld
	$(LD_KERNEL) $(LDFLAGS_KERNEL) $(BUILD)/entry.o $(BUILD)/kernel.o -o $(BUILD)/$(KERNEL)
$(BUILD)/kernel_blob.o: $(BUILD)/$(KERNEL)
	$(OBJCOPY) -I binary -O elf64-x86-64 -B i386:x86-64 $(BUILD)/$(KERNEL) $(BUILD)/kernel_blob.o
...
$(BUILD)/boot.so: $(BUILD)/boot.o $(BUILD)/kernel_blob.o
	$(LD_EFI) $(LDFLAGS_EFI) $(BUILD)/boot.o $(BUILD)/kernel_blob.o -L /usr/lib -lefi -lgnuefi -o $(BUILD)/boot.so
